...
const EditorTheme: { [key: string]: string } = {
  ...
  "--color-canvas-subtle": colors.slate[800],
...
const CodeEditor: FC<CodeEditorProps> = ({
  ...
  return (
    <div className="w-full bg-gradient-to-r from-emerald-600 to-green-600 py-14 mt-20 rounded-lg relative">
      {noise && (
      ...
      <div className={clsx(className)}>
        <div
          className={clsx(
            "h-8 bg-neutral-900/80 rounded-tl-lg rounded-tr-lg grid grid-cols-[100px_1fr_100px]  items-center pl-4 relative"
          )}
        >
